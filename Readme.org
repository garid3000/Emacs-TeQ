...
**  Differential & Derivates
#+caption: Diffs & Derivates
#+name: tbl_6_func_diff
#+attr_latex: :align |llll| :placement [H]
|--------+-------------------------------------------+---------------------------------------+-------------------------------------------------|
| key    | sym                                       | latex                                 | description                                     |
|--------+-------------------------------------------+---------------------------------------+-------------------------------------------------|
| ~dx~   | $\mathrm{d}x$                             | ~\mathrm{d}x~                         |                                                 |
| ~dy~   | $\mathrm{d}y$                             | ~\mathrm{d}y~                         |                                                 |
| ~dz~   | $\mathrm{d}z$                             | ~\mathrm{d}z~                         |                                                 |
| ~dt~   | $\mathrm{d}t$                             | ~\mathrm{d}t~                         |                                                 |
|--------+-------------------------------------------+---------------------------------------+-------------------------------------------------|
| ~dx.~  | $\partial x$                              | ~\partial x~                          | $\mathrm{d} x$  + _._ (var)                     |
| ~dy.~  | $\partial y$                              | ~\partial y~                          | $\mathrm{d} y$  + _._ (var)                     |
| ~dz.~  | $\partial z$                              | ~\partial z~                          | $\mathrm{d} z$  + _._ (var)                     |
| ~dt.~  | $\partial t$                              | ~\partial t~                          | $\mathrm{d} t$  + _._ (var)                     |
|--------+-------------------------------------------+---------------------------------------+-------------------------------------------------|
| ~df~   | $\frac{\mathrm{d}}{\mathrm{d} x}    \Box$ | ~\frac{\mathrm{d}}{\mathrm{d} x}~     |                                                 |
| ~df2~  | $\frac{\mathrm{d}^2}{\mathrm{d} x^2}\Box$ | ~\frac{\mathrm{d}^2}{\mathrm{d}^2 x}~ | $\frac{\mathrm{d}}{\mathrm{d} x}$ + 2           |
| ~df3~  | $\frac{\mathrm{d}^3}{\mathrm{d} x^3}\Box$ | ~\frac{\mathrm{d}^3}{\mathrm{d}^3 x}~ | $\frac{\mathrm{d}}{\mathrm{d} x}$ + 3           |
| ~df4~  | $\frac{\mathrm{d}^4}{\mathrm{d} x^4}\Box$ | ~\frac{\mathrm{d}^4}{\mathrm{d}^4 x}~ | $\frac{\mathrm{d}}{\mathrm{d} x}$ + 4           |
|--------+-------------------------------------------+---------------------------------------+-------------------------------------------------|
| ~df.~  | $\frac{\partial}{\partial x}    \Box$     | ~\frac{\partial}{\partial x}~         | $\frac{\mathrm{d}}{\mathrm{d} x}$  + .(var)     |
| ~df.2~ | $\frac{\partial^2}{\partial x^2}\Box$     | ~\frac{\partial^2}{\partial^2 x}~     | $\frac{\mathrm{d}}{\mathrm{d} x}$  + .(var) + 2 |
| ~df.3~ | $\frac{\partial^3}{\partial x^3}\Box$     | ~\frac{\partial^3}{\partial^3 x}~     | $\frac{\mathrm{d}}{\mathrm{d} x}$  + .(var) + 3 |
| ~df.4~ | $\frac{\partial^4}{\partial x^4}\Box$     | ~\frac{\partial^4}{\partial^4 x}~     | $\frac{\mathrm{d}}{\mathrm{d} x}$  + .(var) + 4 |
|--------+-------------------------------------------+---------------------------------------+-------------------------------------------------|
