...
|--------+----------------+----------------+--------+----------------+----------------|
| ~idd.~ | $\dot{\imath}$ | ~\dot{\imath}~ | ~jdd.~ | $\dot{\jmath}$ | ~\dot{\jmath}~ |
|--------+----------------+----------------+--------+----------------+----------------|
...
| key    | sym                        | latex                | description              |
|--------+----------------------------+----------------------+--------------------------|
| ~<---~ | $\xleftarrow[\Box]{\Box}$  | ~\xleftarrow[ ]{ }~  | these uses triple ~-~    |
| ~--->~ | $\xrightarrow[\Box]{\Box}$ | ~\xrightarrow[ ]{ }~ | these uses triple ~-~    |
...
| key    | sym                    | latex       | key     | sym                     | latex        |
|--------+------------------------+-------------+---------+-------------------------+--------------|
| ~dif~  | $\dd[\Box]{\Box}$      | ~\dd[ ]{~   | ~dif.~  | $\pd[\Box]{\Box}$       | ~\pd[ ]{~    |
|--------+------------------------+-------------+---------+-------------------------+--------------|
| ~dx~   | $\dd{x}$               | ~\dd{x}~    | ~dx.~   | $\pd{x}$                | ~\pd{x}~     |
| ~dy~   | $\dd{y}$               | ~\dd{y}~    | ~dy.~   | $\pd{y}$                | ~\pd{y}~     |
| ~dz~   | $\dd{z}$               | ~\dd{z}~    | ~dz.~   | $\pd{z}$                | ~\pd{z}~     |
| ~dt~   | $\dd{t}$               | ~\dd{t}~    | ~dt.~   | $\pd{t}$                | ~\pd{t}~     |
|--------+------------------------+-------------+---------+-------------------------+--------------|
| ~dx2~  | $\dd[2]{x}$            | ~\dd[2]{x}~ | ~dx.2~  | $\pd[2]{x}$             | ~\pd[2]{x}~  |
| ~dy2~  | $\dd[2]{y}$            | ~\dd[2]{y}~ | ~dy.2~  | $\pd[2]{y}$             | ~\pd[2]{y}~  |
| ~dz2~  | $\dd[2]{z}$            | ~\dd[2]{z}~ | ~dz.2~  | $\pd[2]{z}$             | ~\pd[2]{z}~  |
| ~dt2~  | $\dd[2]{t}$            | ~\dd[2]{t}~ | ~dt.2~  | $\pd[2]{t}$             | ~\pd[2]{t}~  |
|--------+------------------------+-------------+---------+-------------------------+--------------|
| ~dx3~  | $\dd[3]{x}$            | ~\dd[3]{x}~ | ~dx.3~  | $\pd[3]{x}$             | ~\pd[3]{x}~  |
| ~dy3~  | $\dd[3]{y}$            | ~\dd[3]{y}~ | ~dy.3~  | $\pd[3]{y}$             | ~\pd[3]{y}~  |
| ~dz3~  | $\dd[3]{z}$            | ~\dd[3]{z}~ | ~dz.3~  | $\pd[3]{z}$             | ~\pd[3]{z}~  |
| ~dt3~  | $\dd[3]{t}$            | ~\dd[3]{t}~ | ~dt.3~  | $\pd[3]{t}$             | ~\pd[3]{t}~  |
|--------+------------------------+-------------+---------+-------------------------+--------------|
| ~dxn~  | $\dd[n]{x}$            | ~\dd[n]{x}~ | ~dx.n~  | $\pd[n]{x}$             | ~\pd[n]{x}~  |
| ~dyn~  | $\dd[n]{y}$            | ~\dd[n]{y}~ | ~dy.n~  | $\pd[n]{y}$             | ~\pd[n]{y}~  |
| ~dzn~  | $\dd[n]{z}$            | ~\dd[n]{z}~ | ~dz.n~  | $\pd[n]{z}$             | ~\pd[n]{z}~  |
| ~dtn~  | $\dd[n]{t}$            | ~\dd[n]{t}~ | ~dt.n~  | $\pd[n]{t}$             | ~\pd[n]{t}~  |
|--------+------------------------+-------------+---------+-------------------------+--------------|
...
| key    | sym                    | latex       | key     | sym                     | latex        |
|--------+------------------------+-------------+---------+-------------------------+--------------|
| ~df~   | $\dv[\Box]{\Box} \Box$ | ~\dv[ ]{ }~ | ~df.~   | $\pdv[\Box]{\Box} \Box$ | ~\pdv[ ]{ }~ |
| ~dfx~  | $\dv{x }    \Box$      | ~\dv{x}~    | ~df.x~  | $\pdv{x }    \Box$      | ~\pdv{x}~    |
| ~dfy~  | $\dv{y}    \Box$       | ~\dv{y}~    | ~df.y~  | $\pdv{y}    \Box$       | ~\pdv{y}~    |
| ~dfz~  | $\dv{z}    \Box$       | ~\dv{z}~    | ~df.z~  | $\pdv{z}    \Box$       | ~\pdv{z}~    |
| ~dft~  | $\dv{t}    \Box$       | ~\dv{t}~    | ~df.t~  | $\pdv{t}    \Box$       | ~\pdv{t}~    |
|--------+------------------------+-------------+---------+-------------------------+--------------|
| ~df2~  | $\dv[2]{\Box} \Box$    | ~\dv[2]{ }~ | ~df.2~  | $\pdv[2]{\Box} \Box$    | ~\pdv[2]{ }~ |
| ~dfx2~ | $\dv[2]{ x } \Box$     | ~\dv[2]{x}~ | ~df.x2~ | $\pdv[2]{ x } \Box$     | ~\pdv[2]{x}~ |
| ~dfy2~ | $\dv[2]{y} \Box$       | ~\dv[2]{y}~ | ~df.y2~ | $\pdv[2]{y} \Box$       | ~\pdv[2]{y}~ |
| ~dfz2~ | $\dv[2]{z} \Box$       | ~\dv[2]{z}~ | ~df.z2~ | $\pdv[2]{z} \Box$       | ~\pdv[2]{z}~ |
| ~dft2~ | $\dv[2]{t} \Box$       | ~\dv[2]{t}~ | ~df.t2~ | $\pdv[2]{t} \Box$       | ~\pdv[2]{t}~ |
|--------+------------------------+-------------+---------+-------------------------+--------------|
| ~df3~  | $\dv[3]{\Box} \Box$    | ~\dv[3]{ }~ | ~df.3~  | $\pdv[3]{\Box} \Box$    | ~\pdv[3]{ }~ |
| ~dfx3~ | $\dv[3]{ x } \Box$     | ~\dv[3]{x}~ | ~df.x3~ | $\pdv[3]{ x } \Box$     | ~\pdv[3]{x}~ |
| ~dfy3~ | $\dv[3]{y} \Box$       | ~\dv[3]{y}~ | ~df.y3~ | $\pdv[3]{y} \Box$       | ~\pdv[3]{y}~ |
| ~dfz3~ | $\dv[3]{z} \Box$       | ~\dv[3]{z}~ | ~df.z3~ | $\pdv[3]{z} \Box$       | ~\pdv[3]{z}~ |
| ~dft3~ | $\dv[3]{t} \Box$       | ~\dv[3]{t}~ | ~df.t3~ | $\pdv[3]{t} \Box$       | ~\pdv[3]{t}~ |
|--------+------------------------+-------------+---------+-------------------------+--------------|
...
| h \texttt{\textbar}                              |                                           | ~\middle\vert~                  | Vertical bar related |
|--------------------------------------------------+-------------------------------------------+---------------------------------+----------------------|
| $\text{\texttt{\textbar}}$ ~..~                  | $\Box \Bigg\vert_{\Box}^{\Box}$           | ~\Bigg\vert_{~                  | Vertical bar related |
| $\text{\texttt{\textbar}\texttt{\textbar}}$ ~.~  | $\left\vert \Box \right\vert$             | ~\left\vert \right\vert~        | Vertical bar related |
| $\text{\texttt{\textbar}\texttt{\textbar}}$ ~..~ | $\left\Vert \Box \right\Vert$             | ~\left\Vert \right\Vert~        | Vertical bar related |
|--------------------------------------------------+-------------------------------------------+---------------------------------+----------------------|
