...
|-------+---------------------+---------------------+---------------------+---------------------+----------------------+-----------------------+------------------------+--------------------------|
| ~i..~ | $\bar{\imath}$      | $\vec{\imath}$      | $\hat{\imath}$      | $\dot{\imath}$      | $\ddot{\imath}$      | $\dddot{\imath}$      | $\ddddot{\imath}$      | $\mathring{\imath}$      |
| ~j..~ | $\bar{\jmath}$      | $\vec{\jmath}$      | $\hat{\jmath}$      | $\dot{\jmath}$      | $\ddot{\jmath}$      | $\dddot{\jmath}$      | $\ddddot{\jmath}$      | $\mathring{\jmath}$      |
|-------+---------------------+---------------------+---------------------+---------------------+----------------------+-----------------------+------------------------+--------------------------|
