...
|------------------------+--------------------+--------------------+---------------------------------|
| \texttt{\textbar} ~->~ | ~\mapsto~          | $\mapsto$          | vertical-bar + ~->~             |
...
| key    | trans                | sym                        | description              |
|--------+----------------------+----------------------------+--------------------------|
| ~<---~ | ~\xleftarrow[ ]{ }~  | $\xleftarrow[\Box]{\Box}$  | these uses triple - or = |
...
| ~[].~                                   | ~\left[ \right]~                 | $\left[ \Box \right]$                     |                         |
| ~[]..~                                  | ~\left[ \middle\vert  \right]~   | $\left[ \Box \middle\vert \Box \right]$   | (var)                   |
| ~[].c~                                  | ~\lceil \rceil~                  | $\lceil \Box \rceil$                      | (var) (ceil)            |
| ~[].f~                                  | ~\lfloor \rfloor~                | $\lfloor \Box \rfloor$                    | (var) (floor)           |
| ~{}.~                                   | ~\left\{ \right\}~               | $\left\{ \Box \right\}$                   |                         |
| ~{}..~                                  | ~\left\{ \middle\vert  \right\}~ | $\left\{ \Box \middle\vert \Box \right\}$ | (var)                   |
| ~<>.~                                   | ~\left< \right>~                 | $\left< \Box \right>$                     |                         |
| ~<>..~                                  | ~\left< \middle\vert \right>~    | $\left< \Box \middle\vert \Box \right>$   | (var)                   |
| \texttt{\textbar}\texttt{\textbar} ~.~  | ~\left\vert \right\vert~         | $\left\vert \Box \right\vert$             |                         |
| \texttt{\textbar}\texttt{\textbar} ~..~ | ~\left\Vert \right\Vert~         | $\left\Vert \Box \right\Vert$             | (var)                   |
|-----------------------------------------+----------------------------------+-------------------------------------------+-------------------------|
| ~(.~                                    | ~\left(~                         | \(\left( \Box \right.\)                   | half (                  |
| ~).~                                    | ~\right)~                        | $\left. \Box \right)$                     | half )                  |
| ~[.~                                    | ~\left[~                         | \(\left[ \Box \right.\)                   | half [                  |
| ~].~                                    | ~\right]~                        | $\left. \Box \right]$                     | half ]                  |
| ~{.~                                    | ~\left\{~                        | \(\left\{ \Box \right.\)                  | half {                  |
| ~}.~                                    | ~\right\}~                       | $\left. \Box \right\}$                    | half }                  |
...
| ~)..~                                   | ~\right.~                        |                                           | half right .            |
|-----------------------------------------+----------------------------------+-------------------------------------------+-------------------------|
| \texttt{\textbar} ~.~                   | ~\Bigg\vert_{ }^{ }~             | $\Box\Bigg\vert_{\Box}^{\Box}$            | definite integral range |
|-----------------------------------------+----------------------------------+-------------------------------------------+-------------------------|
...
| key  | trans      | sym                      | description      |
|------+------------+--------------------------+------------------|
| ~te~ | ~\text{~   | $\Box + \text{text}$     | (te)xt           |
| ~tr~ | ~\mathrm{~ | $\Box + \mathrm{mathrm}$ | (t)ext (r)oman   |
| ~tb~ | ~\mathbf{~ | $\Box + \mathbf{mathbf}$ | (t)ext (b)old    |
| ~ti~ | ~\mathit{~ | $\Box + \mathit{mathit}$ | (t)ext (i)talics |
|------+------------+--------------------------+------------------|
