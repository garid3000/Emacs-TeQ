...
| ~dif~ | $\mathrm{d}$      |                   |                   |                   |                   |
|-------+-------------------+-------------------+-------------------+-------------------+-------------------|
| ~d~   |                   | $\mathrm{d} x$    | $\mathrm{d} y$    | $\mathrm{d} z$    | $\mathrm{d} t$    |
| ~d2~  | $\mathrm{d} ^2 x$ | $\mathrm{d} ^2 x$ | $\mathrm{d} ^2 y$ | $\mathrm{d} ^2 z$ | $\mathrm{d} ^2 t$ |
| ~d3~  | $\mathrm{d} ^3 x$ | $\mathrm{d} ^3 x$ | $\mathrm{d} ^3 y$ | $\mathrm{d} ^3 z$ | $\mathrm{d} ^3 t$ |
| ~dn~  | $\mathrm{d} ^n x$ | $\mathrm{d} ^n x$ | $\mathrm{d} ^n y$ | $\mathrm{d} ^n z$ | $\mathrm{d} ^n t$ |
|-------+-------------------+-------------------+-------------------+-------------------+-------------------|
...
|-------+------------------+---|
 ...
 |--------+----------------+-------------|
 |--------+----------------+-------------|
 | ~d2x.~ | $\partial^2 x$ | ~\pd[2]{x}~ |
 | ~d2y.~ | $\partial^2 y$ | ~\pd[2]{y}~ |
 | ~d2z.~ | $\partial^2 z$ | ~\pd[2]{z}~ |
 | ~d2t.~ | $\partial^2 t$ | ~\pd[2]{t}~ |
 |--------+----------------+-------------|
 | ~d3x.~ | $\partial^3 x$ | ~\pd[3]{x}~ |
 | ~d3y.~ | $\partial^3 y$ | ~\pd[3]{y}~ |
 | ~d3z.~ | $\partial^3 z$ | ~\pd[3]{z}~ |
 | ~d3t.~ | $\partial^3 t$ | ~\pd[3]{t}~ |
 |--------+----------------+-------------|
 | ~dnx.~ | $\partial^n x$ | ~\pd[n]{x}~ |
 | ~dny.~ | $\partial^n y$ | ~\pd[n]{y}~ |
 | ~dnz.~ | $\partial^n z$ | ~\pd[n]{z}~ |
 | ~dnt.~ | $\partial^n t$ | ~\pd[n]{t}~ |
 |--------+----------------+-------------|
 |--------+----------------+-------------|
 | ~dx.2~ | $\partial x^2$ | ~\pd{x}^2~  |
 | ~dy.2~ | $\partial y^2$ | ~\pd{y}^2~  |
 | ~dz.2~ | $\partial z^2$ | ~\pd{z}^2~  |
 | ~dt.2~ | $\partial t^2$ | ~\pd{t}^2~  |
 |--------+----------------+-------------|
 | ~dx.3~ | $\partial x^3$ | ~\pd{x}^3~  |
 | ~dy.3~ | $\partial y^3$ | ~\pd{y}^3~  |
 | ~dz.3~ | $\partial z^3$ | ~\pd{z}^3~  |
 | ~dt.3~ | $\partial t^3$ | ~\pd{t}^3~  |
 |--------+----------------+-------------|
 | ~dx.n~ | $\partial x^n$ | ~\pd{x}^n~  |
 | ~dy.n~ | $\partial y^n$ | ~\pd{y}^n~  |
 | ~dz.n~ | $\partial z^n$ | ~\pd{z}^n~  |
 | ~dt.n~ | $\partial t^n$ | ~\pd{t}^n~  |
 |--------+----------------+-------------|
