...
| ~h~ \vert       |                                           | ~\middle\vert~                  | Vertical bar related |
|-----------------+-------------------------------------------+---------------------------------+----------------------|
| \vert ~..~      | $\Box \Big\vert_{\Box}^{\Box}$            | ~\Bigg\vert_{~                  | Vertical bar related |
| \vert\vert ~.~  | $\left\vert \Box \right\vert$             | ~\left\vert \right\vert~        | Vertical bar related |
| \vert\vert ~..~ | $\left\Vert \Box \right\Vert$             | ~\left\Vert \right\Vert~        | Vertical bar related |
|-----------------+-------------------------------------------+---------------------------------+----------------------|
