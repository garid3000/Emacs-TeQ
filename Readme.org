...
#+caption: Diffs and Derivates
#+name: tbl_6_func_diff
#+attr_latex: :align |llll| :placement [H]
|--------+---------------------------------------+---------------------------------------+---------------------------|
| key    | sym                                   | latex                                 | description               |
|--------+---------------------------------------+---------------------------------------+---------------------------|
| ~dx~   | $\mathrm{d}$                          | ~\mathrm{d}~                          |                           |
| ~df~   | $\frac{\mathrm{d}}{\mathrm{d} x}$     | ~\frac{\mathrm{d}}{\mathrm{d} x}~     |                           |
| ~df2~  | $\frac{\mathrm{d}^2}{\mathrm{d} x^2}$ | ~\frac{\mathrm{d}^2}{\mathrm{d}^2 x}~ |                           |
| ~df3~  | $\frac{\mathrm{d}^3}{\mathrm{d} x^3}$ | ~\frac{\mathrm{d}^3}{\mathrm{d}^3 x}~ |                           |
| ~df4~  | $\frac{\mathrm{d}^4}{\mathrm{d} x^4}$ | ~\frac{\mathrm{d}^4}{\mathrm{d}^4 x}~ |                           |
|--------+---------------------------------------+---------------------------------------+---------------------------|
| ~dx.~  | $\partial$                            | ~\partial~                            | $\mathrm{d}$  + _._ (var) |
| ~df.~  | $\frac{\partial}{\partial x}$         | ~\frac{\partial}{\partial x}~         |                           |
| ~df.2~ | $\frac{\partial^2}{\partial x^2}$     | ~\frac{\partial^2}{\partial^2 x}~     |                           |
| ~df.3~ | $\frac{\partial^3}{\partial x^3}$     | ~\frac{\partial^3}{\partial^3 x}~     |                           |
| ~df.4~ | $\frac{\partial^4}{\partial x^4}$     | ~\frac{\partial^4}{\partial^4 x}~     |                           |
|--------+---------------------------------------+---------------------------------------+---------------------------|
