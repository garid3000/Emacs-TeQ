...
| ~il~      | $\sum\limits_{ \Box }^{ \Box}$        | ~\limits_{ }^{ }~                     |             |
|-----------+---------------------------------------+---------------------------------------+-------------|
| ~lim~     | $\lim$                                | ~\lim~                                |             |
| ~sum~     | $\sum$                                | ~\sum~                                |             |
| ~prod~    | $\prod$                               | ~\prod~                               |             |
...
| ~int.~    | $\int\limits_{ \Box }^{ \Box }$       | ~\int\limits_{ }^{ }~                 |             |
| ~int..~   | $\int\limits_{ 0 }^{ +\infty }$       | ~\int\limits_{ 0 }^{ +\infty }~       |             |
| ~int...~  | $\int\limits_{ -\infty }^{ +\infty }$ | ~\int\limits_{ -\infty }^{ +\infty }~ |             |
| ~inti.~   | $\iint\limits_{ C }$                  | ~\iint\limits_{ }~                    |             |
| ~intii.~  | $\iiint\limits_{ C }$                 | ~\iiint\limits_{ }~                   |             |
| ~intiii.~ | $\iiiint\limits_{ C }$                | ~\iiiint\limits_{ }~                  |             |
| ~into.~   | $\oint\limits_{ C }$                  | ~\oint\limits_{ }~                    |             |
|-----------+---------------------------------------+---------------------------------------+-------------|
...
| \texttt{\textbar}\texttt{\textbar} ~..~ | $\left\Vert \Box \right\Vert$             | ~\left\Vert \right\Vert~         | (var)                   |
|-----------------------------------------+-------------------------------------------+----------------------------------+-------------------------|
...
| ~)..~                                   |                                           | ~\right.~                        | half right .            |
|-----------------------------------------+-------------------------------------------+----------------------------------+-------------------------|
| \texttt{\textbar} ~.~                   | $\Box\Bigg\vert_{\Box}^{\Box}$            | ~\Bigg\vert_{ }^{ }~             | definite integral range |
|-----------------------------------------+-------------------------------------------+----------------------------------+-------------------------|
